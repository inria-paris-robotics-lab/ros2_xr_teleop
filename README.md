# ros2_xr_teleop — VR teleoperation for ROS 2 arms (Meta Quest 2 / HTC Vive)
...
```bash
git clone https://github.com/inria-paris-robotics-lab/ros2_xr_teleop.git ~/ros2_xr_teleop
```
